...
public class AppointmentController {
    ...
    public ResponseEntity<List<Appointment>> listAppointmentofPatient(){
        return new ResponseEntity<List<Appointment>>(AppointmentRepository.findByPatientId(), HttpStatus.OK);
    }
